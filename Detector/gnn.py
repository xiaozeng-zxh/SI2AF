...
parser.add_argument('--dropout_ratio', type=float,
                    default=0.0, help='dropout ratio')  # 0.0
...
parser.add_argument('--base_model', type=str, default='bi-gcn',
                    help='model type, [gcn, gat, sage, bi-gcn, gcan]')
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), f"trained_model/{args.dataset[:3]}_{args.base_model}_hop_{args.nhop}.pth")
